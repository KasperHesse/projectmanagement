...
#    Then an activity named "research" exists under the current project with start date "2021-04-01" and end date "2021-05-01"
#
...
#    When they create an activity named "research" under the current project
#    Then the error message "Developers cannot create new activities" is given.